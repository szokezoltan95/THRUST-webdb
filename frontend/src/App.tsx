              ...
              {activeSection === "participants" && <>
                ...
                {selectedParticipant && participantDialog && (() => {
                  ...
                  if (participantDialog === "detail") return <section className="browser-detail detail-modal-open participant-detail-modal">
                     <div className="detail-header"><div><div className="eyebrow">DETAIL ÚČASTNÍKA</div><h2>{participant.participant_code}</h2></div><div className="detail-header-actions"><ModeSwitch value={resultMode} onChange={changeResultMode} /><button className="quiet compact" onClick={() => setParticipantDialog(null)}>Zavrieť</button></div></div>
                     {accountMessage && <p className="notice">{accountMessage}</p>}
                   ...
                   return <section className="browser-detail detail-modal-open participant-detail-modal">
                    <div className="detail-header"><div><div className="eyebrow">MERANIA ÚČASTNÍKA</div><h2>{participant.participant_code}</h2></div><div className="detail-header-actions"><ModeSwitch value={resultMode} onChange={changeResultMode} /><button className="quiet compact" onClick={() => setParticipantDialog(null)}>Zavrieť</button></div></div>
              ...
              {activeSection === "measurements" && <>
                <div className="workbench">
                  ...
                  <section className={selectedMeasurementId ? "panel workbench-detail detail-modal-open" : "panel workbench-detail detail-modal-closed"}>
                    <div className="detail-window-bar"><div className="eyebrow">PRACOVNÝ PANEL</div><div className="detail-header-actions"><ModeSwitch value={resultMode} onChange={changeResultMode} /><button className="quiet compact" onClick={() => setSelectedMeasurementId(null)}>Zavrieť</button></div></div>
